                        ...
                        <form action="" method="post" id="newComplianceForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('start_on') is-invalid @enderror" aria-label="Default select example" name="start_on" value="{{ old('start_on') }}" id="nStartOn">
                                        <option selected disabled>Select Start</option>
                                        @foreach (config('static_data.start_on') as $key => $startOn)
                                            <option value="{{ $key }}">{{ $startOn }}</option>
                                        @endforeach
                                    </select>
