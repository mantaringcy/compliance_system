<div>
    <!-- Modal -->
    <div class="modal fade modal-lg" id="editComplianceModal" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title fw-semibold" id="staticBackdropLabel">Edit Compliance</h5>
                        ...
                        <form action="" method="post" enctype="multipart/form-data" id="editComplianceForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="compliance_name" class="form-control @error('compliance_name') is-invalid @enderror" placeholder="Compliance Name" id="complianceName">             

                                    <div class="invalid-feedback compliance_name" style="display: block;"></div>
                                    @error('compliance_name')
                                        <div class="invalid-feedback compliance_name" style="display: block;">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-5">
                                    ...
                                    <select class="form-select @error('department_id') is-invalid @enderror" aria-label="Default select example" name="department_id" id="departmentSelect" value="haha">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" name="reference_date" class="@error('reference_date') is-invalid @enderror w-100" style="padding: 10px !important;" id="referenceDate">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('frequency') is-invalid @enderror" aria-label="Default select example" name="frequency" id="frequency">
                                    ...
                                    @error('frequency')
                                        <div class="invalid-feedback" id="frequency">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <select class="form-select @error('submit_on') is-invalid @enderror" aria-label="Default select example" name="submit_on" id="submitOn">
                            ...
                            <div class="modal-footer">
                                ...
                                <button class="btn border-0 text-white">Update</button>
                            </div>
