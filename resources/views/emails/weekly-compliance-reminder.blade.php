        ...
        <tr>
            <td align="center">
                ...
                <table role="presentation" style="background-color: #ffffff; padding: 20px; border-radius: 8px; border: 1px solid #ddd;">
                    <tr>
                        <td>
                            <h2 style="color: #333333; font-size: 24px; text-align: center;">Weekly Compliance Reminder</h2>
                            <p style="color: #666666; font-size: 16px; text-align: center;">This is a reminder for the status of your compliance this month.</p>
