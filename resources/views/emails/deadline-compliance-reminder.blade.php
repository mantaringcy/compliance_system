...
<head>
    ...
    <title>Compliance Reminder | Deadline 5 Days From Now</title>
</head>
        ...
        <tr>
            <td align="center">
                ...
                <table role="presentation" style="background-color: #ffffff; padding: 20px; border-radius: 8px; border: 1px solid #E7EAEE;">
                    <tr>
                        <td>
                            <h2 style="color: #131920; font-size: 24px; text-align: center;">Upcoming Compliance Deadlines</h2>
                            ...
                            <table role="presentation" style="width: 100%; margin-top: 20px; border-collapse: collapse;">
                                <thead
                                    style="
                                        ...
                                        ">
                                    <tr>
                                        <th style="text-align: left; padding: 8px;">Compliance Name</th>
                                        <th style="text-align: left; padding: 8px;">Start Date</th>
                                        <th style="text-align: left; padding: 8px;">Submit Date</th>
