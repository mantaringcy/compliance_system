        ...
        <tr>
            <td align="center">
                ...
                <table role="presentation" style="background-color: #ffffff; padding: 20px; border-radius: 8px; border: 1px solid #ddd;">
                    <tr>
                        <td>
                            <h2 style="color: #333333; font-size: 24px; text-align: center;">Compliance Update Approved</h2>
                            <p style="color: #666666; font-size: 16px; text-align: center;">The requested updates to the compliance have been approved. The compliance details have been updated successfully.</p>
