...
<head>
    ...
    <title>Compliance Reminder | Monthly Compliance Reminder</title>
</head>
    ...
    <table role="presentation" style="width: 100%; background-color: #F8F9FA; padding: 20px;">
        <tr>
            <td align="center">
                ...
                <table role="presentation" style="background-color: #ffffff; padding: 20px; border-radius: 10px; border: 1px solid #E7EAEE;">
                    <tr>
                        <td>
                            <h2 style="color: #131920; font-size: 24px; text-align: center;">Monthly Compliance Reminder</h2>
                            <p style="color: #666666; font-size: 16px; text-align: center;">This is a reminder for the upcoming monthly compliance deadlines.</p>
                                ...
                                <tbody>
                                    @foreach ($compliances as $compliance)
                                        <tr
                                            ...
                                            ">
                                            <td style="padding: 10px; border-bottom: 1px solid #E7EAEE;">{{ $compliance['compliance_name'] }}</td>
