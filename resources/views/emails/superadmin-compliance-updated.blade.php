        ...
        <tr>
            <td align="center">
                ...
                <table role="presentation" style="background-color: #ffffff; padding: 20px; border-radius: 8px; border: 1px solid #ddd;">
                    <tr>
                        <td>
                            <h2 style="color: #333333; font-size: 24px; text-align: center;">Compliance Details Updated</h2>
                            <p style="color: #666666; font-size: 16px; text-align: center;">Important: Compliance details have been updated. Please review the changes to ensure compliance is met on time.
                            </p>
